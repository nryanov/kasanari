...
public class KasanariMultiTableTransaction implements Transaction {
    ...
    private final KasanariMultiTableTransaction.TransactionType type;
    ...
    public KasanariMultiTableTransaction(
        ...
        this.ops = ops;
        this.transactionTable = new KasanariMultiTableTransaction.TransactionTable();
        this.current = start;
        this.transactionOps = new KasanariMultiTableTransaction.TransactionTableOperations();
        ...
        if (base != underlyingOps.refresh()) {
            ...
            for (PendingUpdate update : updates) {
                ...
                try {
                    ...
                    // retry-loop.
                    throw new KasanariMultiTableTransaction.PendingUpdateFailedException(e);
                }
            }
        }
    }
