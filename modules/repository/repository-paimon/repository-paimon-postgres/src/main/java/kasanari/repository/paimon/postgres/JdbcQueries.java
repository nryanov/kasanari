...
public final class JdbcQueries {
    ...
    public static final String CREATE_DATABASES_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_databases_pk PRIMARY KEY (catalog_name, database_name)
            )
            """;
    ...
    public static final String CREATE_TABLES_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_tables_pk PRIMARY KEY (catalog_name, database_name, table_name),
    ...
    public static final String CREATE_PARTITION_STATS_DELTAS_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_partition_stats_deltas_pk PRIMARY KEY (
                    catalog_name, database_name, table_name, branch_name, snapshot_id, spec_hash
                ),
    ...
    public static final String CREATE_PARTITION_STATES_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_partition_states_pk PRIMARY KEY (
                    catalog_name, database_name, table_name, branch_name, spec_hash
                ),
    ...
    public static final String CREATE_VIEWS_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_views_pk PRIMARY KEY (catalog_name, database_name, view_name),
    ...
    public static final String CREATE_FUNCTIONS_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_functions_pk PRIMARY KEY (catalog_name, database_name, function_name),
    ...
    public static final String CREATE_BRANCHES_DDL = """
            ...
            (
                ...
                created_at    TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                updated_at    TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CONSTRAINT kasanari_paimon_branches_pk PRIMARY KEY (catalog_name, database_name, table_name, branch_name),
    ...
    public static final String CREATE_TAGS_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_paimon_tags_pk PRIMARY KEY (catalog_name, database_name, table_name, tag_name),
