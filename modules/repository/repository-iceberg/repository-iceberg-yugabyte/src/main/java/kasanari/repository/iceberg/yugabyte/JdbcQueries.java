...
public class JdbcQueries {
    public final static String CREATE_CATALOGS_DDL = """
            ...
            (
                ...
                CONSTRAINT kasanari_iceberg_catalog_pk PRIMARY KEY (catalog_name HASH)
    ...
    public final static String CREATE_NAMESPACES_DDL = """
            ...
            (
                ...
                created_at     TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                updated_at     TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CONSTRAINT kasanari_iceberg_namespaces_pk PRIMARY KEY (catalog_name HASH, namespace_name ASC),
    ...
    public final static String CREATE_NAMESPACE_PROPERTIES_DDL = """
            ...
            (
                ...
                created_at     TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                updated_at     TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CONSTRAINT kasanari_iceberg_namespace_properties_pk PRIMARY KEY (catalog_name HASH, namespace_name ASC, property_key ASC),
    ...
    public final static String CREATE_TABLES_DDL = """
            ...
            (
                ...
                created_at                 TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                updated_at                 TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CONSTRAINT kasanari_iceberg_tables_pk PRIMARY KEY (catalog_name HASH, namespace_name ASC, table_name ASC),
    ...
    public final static String CREATE_VIEWS_DDL = """
            ...
            (
                ...
                created_at                 TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                updated_at                 TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CONSTRAINT kasanari_iceberg_views_pk PRIMARY KEY (catalog_name HASH, namespace_name ASC, view_name ASC),
